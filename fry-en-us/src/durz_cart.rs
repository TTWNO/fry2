...
const VAL_0000: ValueAtom<'static> = ValueAtom::Str("pau");
const VAL_0001: ValueAtom<'static> = ValueAtom::Str("+");
const VAL_0002: ValueAtom<'static> = ValueAtom::Float(-0.500000);
const VAL_0003: ValueAtom<'static> = ValueAtom::Str("BB");
const VAL_0004: ValueAtom<'static> = ValueAtom::Float(2.000000);
const VAL_0005: ValueAtom<'static> = ValueAtom::Float(0.000000);
const VAL_0006: ValueAtom<'static> = ValueAtom::Str("0");
const VAL_0007: ValueAtom<'static> = ValueAtom::Float(1.5);
const VAL_0008: ValueAtom<'static> = ValueAtom::Str("n");
const VAL_0009: ValueAtom<'static> = ValueAtom::Str("f");
const VAL_0010: ValueAtom<'static> = ValueAtom::Float(-0.783163);
const VAL_0011: ValueAtom<'static> = ValueAtom::Float(-0.222704);
const VAL_0012: ValueAtom<'static> = ValueAtom::Str("s");
const VAL_0013: ValueAtom<'static> = ValueAtom::Str("2");
const VAL_0014: ValueAtom<'static> = ValueAtom::Float(0.764459);
const VAL_0015: ValueAtom<'static> = ValueAtom::Float(0.700000);
const VAL_0016: ValueAtom<'static> = ValueAtom::Float(0.567944);
const VAL_0017: ValueAtom<'static> = ValueAtom::Float(0.053027);
const VAL_0018: ValueAtom<'static> = ValueAtom::Str("l");
const VAL_0019: ValueAtom<'static> = ValueAtom::Str("1");
const VAL_0020: ValueAtom<'static> = ValueAtom::Float(0.766486);
const VAL_0021: ValueAtom<'static> = ValueAtom::Float(0.279248);
const VAL_0022: ValueAtom<'static> = ValueAtom::Float(0.056777);
const VAL_0023: ValueAtom<'static> = ValueAtom::Str("coda");
const VAL_0024: ValueAtom<'static> = ValueAtom::Float(-0.038356);
const VAL_0025: ValueAtom<'static> = ValueAtom::Float(-0.545853);
const VAL_0026: ValueAtom<'static> = ValueAtom::Float(-0.765994);
const VAL_0027: ValueAtom<'static> = ValueAtom::Str("det");
const VAL_0028: ValueAtom<'static> = ValueAtom::Float(0.300000);
const VAL_0029: ValueAtom<'static> = ValueAtom::Float(1.000000);
const VAL_0030: ValueAtom<'static> = ValueAtom::Float(0.160195);
const VAL_0031: ValueAtom<'static> = ValueAtom::Float(0.713958);
const VAL_0032: ValueAtom<'static> = ValueAtom::Float(-0.215472);
const VAL_0033: ValueAtom<'static> = ValueAtom::Str("r");
const VAL_0034: ValueAtom<'static> = ValueAtom::Float(0.092772);
const VAL_0035: ValueAtom<'static> = ValueAtom::Float(0.001328);
const VAL_0036: ValueAtom<'static> = ValueAtom::Float(-0.334898);
const VAL_0037: ValueAtom<'static> = ValueAtom::Float(0.500000);
const VAL_0038: ValueAtom<'static> = ValueAtom::Float(0.200000);
const VAL_0039: ValueAtom<'static> = ValueAtom::Float(-0.041618);
const VAL_0040: ValueAtom<'static> = ValueAtom::Float(2.3);
const VAL_0041: ValueAtom<'static> = ValueAtom::Float(0.262952);
const VAL_0042: ValueAtom<'static> = ValueAtom::Float(0.594794);
const VAL_0043: ValueAtom<'static> = ValueAtom::Str("mid");
const VAL_0044: ValueAtom<'static> = ValueAtom::Float(-0.760444);
const VAL_0045: ValueAtom<'static> = ValueAtom::Float(6.8);
const VAL_0046: ValueAtom<'static> = ValueAtom::Str("a");
const VAL_0047: ValueAtom<'static> = ValueAtom::Float(-0.450449);
const VAL_0048: ValueAtom<'static> = ValueAtom::Float(1.3);
const VAL_0049: ValueAtom<'static> = ValueAtom::Float(-0.296956);
const VAL_0050: ValueAtom<'static> = ValueAtom::Float(2.4);
const VAL_0051: ValueAtom<'static> = ValueAtom::Float(0.042287);
const VAL_0052: ValueAtom<'static> = ValueAtom::Float(-0.154465);
const VAL_0053: ValueAtom<'static> = ValueAtom::Float(3.6);
const VAL_0054: ValueAtom<'static> = ValueAtom::Float(1.2);
const VAL_0055: ValueAtom<'static> = ValueAtom::Float(-0.264199);
const VAL_0056: ValueAtom<'static> = ValueAtom::Float(-0.541738);
const VAL_0057: ValueAtom<'static> = ValueAtom::Float(-0.166623);
const VAL_0058: ValueAtom<'static> = ValueAtom::Float(-0.571730);
const VAL_0059: ValueAtom<'static> = ValueAtom::Str("cc");
const VAL_0060: ValueAtom<'static> = ValueAtom::Float(0.313289);
const VAL_0061: ValueAtom<'static> = ValueAtom::Float(0.069582);
const VAL_0062: ValueAtom<'static> = ValueAtom::Float(2.7);
const VAL_0063: ValueAtom<'static> = ValueAtom::Float(-0.367088);
const VAL_0064: ValueAtom<'static> = ValueAtom::Float(-0.194887);
const VAL_0065: ValueAtom<'static> = ValueAtom::Float(-0.063749);
const VAL_0066: ValueAtom<'static> = ValueAtom::Float(-0.333421);
const VAL_0067: ValueAtom<'static> = ValueAtom::Float(-0.165383);
const VAL_0068: ValueAtom<'static> = ValueAtom::Float(-0.516332);
const VAL_0069: ValueAtom<'static> = ValueAtom::Float(-0.779112);
const VAL_0070: ValueAtom<'static> = ValueAtom::Float(-0.337611);
const VAL_0071: ValueAtom<'static> = ValueAtom::Float(1.4);
const VAL_0072: ValueAtom<'static> = ValueAtom::Float(-0.745807);
const VAL_0073: ValueAtom<'static> = ValueAtom::Float(-1.049_07);
const VAL_0074: ValueAtom<'static> = ValueAtom::Float(-0.914974);
const VAL_0075: ValueAtom<'static> = ValueAtom::Str("initial");
const VAL_0076: ValueAtom<'static> = ValueAtom::Float(0.172658);
const VAL_0077: ValueAtom<'static> = ValueAtom::Float(-0.101423);
const VAL_0078: ValueAtom<'static> = ValueAtom::Float(-0.360092);
const VAL_0079: ValueAtom<'static> = ValueAtom::Float(2.9);
const VAL_0080: ValueAtom<'static> = ValueAtom::Float(1.1);
const VAL_0081: ValueAtom<'static> = ValueAtom::Float(0.764189);
const VAL_0082: ValueAtom<'static> = ValueAtom::Float(0.555132);
const VAL_0083: ValueAtom<'static> = ValueAtom::Float(0.369882);
const VAL_0084: ValueAtom<'static> = ValueAtom::Float(0.666966);
const VAL_0085: ValueAtom<'static> = ValueAtom::Float(0.400000);
const VAL_0086: ValueAtom<'static> = ValueAtom::Float(0.240634);
const VAL_0087: ValueAtom<'static> = ValueAtom::Float(0.486176);
const VAL_0088: ValueAtom<'static> = ValueAtom::Float(0.573811);
const VAL_0089: ValueAtom<'static> = ValueAtom::Float(0.194468);
const VAL_0090: ValueAtom<'static> = ValueAtom::Float(0.499383);
const VAL_0091: ValueAtom<'static> = ValueAtom::Float(0.073732);
const VAL_0092: ValueAtom<'static> = ValueAtom::Float(0.331014);
const VAL_0093: ValueAtom<'static> = ValueAtom::Float(0.092930);
const VAL_0094: ValueAtom<'static> = ValueAtom::Float(-0.044327);
const VAL_0095: ValueAtom<'static> = ValueAtom::Float(0.517681);
const VAL_0096: ValueAtom<'static> = ValueAtom::Float(0.128316);
const VAL_0097: ValueAtom<'static> = ValueAtom::Float(0.361383);
const VAL_0098: ValueAtom<'static> = ValueAtom::Float(0.054136);
const VAL_0099: ValueAtom<'static> = ValueAtom::Float(0.246742);
const VAL_0100: ValueAtom<'static> = ValueAtom::Float(0.621547);
const VAL_0101: ValueAtom<'static> = ValueAtom::Float(0.501679);
const VAL_0102: ValueAtom<'static> = ValueAtom::Float(3.3);
const VAL_0103: ValueAtom<'static> = ValueAtom::Float(-0.042049);
const VAL_0104: ValueAtom<'static> = ValueAtom::Float(0.183226);
const VAL_0105: ValueAtom<'static> = ValueAtom::Float(0.284799);
const VAL_0106: ValueAtom<'static> = ValueAtom::Float(-0.820934);
const VAL_0107: ValueAtom<'static> = ValueAtom::Float(-0.348735);
const VAL_0108: ValueAtom<'static> = ValueAtom::Float(-0.400920);
const VAL_0109: ValueAtom<'static> = ValueAtom::Float(-0.639366);
const VAL_0110: ValueAtom<'static> = ValueAtom::Float(0.364857);
const VAL_0111: ValueAtom<'static> = ValueAtom::Float(3.4);
const VAL_0112: ValueAtom<'static> = ValueAtom::Float(-0.007686);
const VAL_0113: ValueAtom<'static> = ValueAtom::Float(-0.197753);
const VAL_0114: ValueAtom<'static> = ValueAtom::Float(-0.394632);
const VAL_0115: ValueAtom<'static> = ValueAtom::Float(0.100000);
const VAL_0116: ValueAtom<'static> = ValueAtom::Float(0.938841);
const VAL_0117: ValueAtom<'static> = ValueAtom::Float(-0.079664);
const VAL_0118: ValueAtom<'static> = ValueAtom::Float(0.480026);
const VAL_0119: ValueAtom<'static> = ValueAtom::Float(0.127175);
const VAL_0120: ValueAtom<'static> = ValueAtom::Float(-0.708767);
const VAL_0121: ValueAtom<'static> = ValueAtom::Float(-0.236212);
const VAL_0122: ValueAtom<'static> = ValueAtom::Float(-0.273389);
const VAL_0123: ValueAtom<'static> = ValueAtom::Str("in");
const VAL_0124: ValueAtom<'static> = ValueAtom::Float(0.058134);
const VAL_0125: ValueAtom<'static> = ValueAtom::Float(0.721904);
const VAL_0126: ValueAtom<'static> = ValueAtom::Float(2.2);
const VAL_0127: ValueAtom<'static> = ValueAtom::Float(0.016121);
const VAL_0128: ValueAtom<'static> = ValueAtom::Float(0.227372);
const VAL_0129: ValueAtom<'static> = ValueAtom::Float(0.445569);
const VAL_0130: ValueAtom<'static> = ValueAtom::Float(-0.120097);
const VAL_0131: ValueAtom<'static> = ValueAtom::Float(0.219042);
const VAL_0132: ValueAtom<'static> = ValueAtom::Float(0.321245);
const VAL_0133: ValueAtom<'static> = ValueAtom::Float(0.134075);
const VAL_0134: ValueAtom<'static> = ValueAtom::Float(-0.466418);
const VAL_0135: ValueAtom<'static> = ValueAtom::Float(-0.425925);
const VAL_0136: ValueAtom<'static> = ValueAtom::Float(-0.542809);
const VAL_0137: ValueAtom<'static> = ValueAtom::Float(-0.201899);
const VAL_0138: ValueAtom<'static> = ValueAtom::Float(0.209018);
const VAL_0139: ValueAtom<'static> = ValueAtom::Float(-0.178136);
const VAL_0140: ValueAtom<'static> = ValueAtom::Float(-0.235593);
const VAL_0141: ValueAtom<'static> = ValueAtom::Float(0.126118);
const VAL_0142: ValueAtom<'static> = ValueAtom::Float(-0.174812);
const VAL_0143: ValueAtom<'static> = ValueAtom::Str("content");
const VAL_0144: ValueAtom<'static> = ValueAtom::Float(-0.231509);
const VAL_0145: ValueAtom<'static> = ValueAtom::Float(-0.536405);
const VAL_0146: ValueAtom<'static> = ValueAtom::Float(0.163343);
const VAL_0147: ValueAtom<'static> = ValueAtom::Float(-0.455280);
const VAL_0148: ValueAtom<'static> = ValueAtom::Float(-0.099803);
const VAL_0149: ValueAtom<'static> = ValueAtom::Float(-0.930547);
const VAL_0150: ValueAtom<'static> = ValueAtom::Float(-0.634119);
const VAL_0151: ValueAtom<'static> = ValueAtom::Float(-0.760176);
const VAL_0152: ValueAtom<'static> = ValueAtom::Float(-0.121355);
const VAL_0153: ValueAtom<'static> = ValueAtom::Float(-0.557509);
const VAL_0154: ValueAtom<'static> = ValueAtom::Float(-0.402734);
const VAL_0155: ValueAtom<'static> = ValueAtom::Float(-0.988478);
const VAL_0156: ValueAtom<'static> = ValueAtom::Float(-0.802536);
const VAL_0157: ValueAtom<'static> = ValueAtom::Float(-0.900628);
const VAL_0158: ValueAtom<'static> = ValueAtom::Float(-0.768992);
const VAL_0159: ValueAtom<'static> = ValueAtom::Float(-0.574918);
const VAL_0160: ValueAtom<'static> = ValueAtom::Float(-0.756359);
const VAL_0161: ValueAtom<'static> = ValueAtom::Float(-0.808937);
const VAL_0162: ValueAtom<'static> = ValueAtom::Float(-0.933150);
const VAL_0163: ValueAtom<'static> = ValueAtom::Float(-0.428493);
const VAL_0164: ValueAtom<'static> = ValueAtom::Float(0.021107);
const VAL_0165: ValueAtom<'static> = ValueAtom::Float(-0.254485);
const VAL_0166: ValueAtom<'static> = ValueAtom::Float(-0.389966);
const VAL_0167: ValueAtom<'static> = ValueAtom::Float(0.185781);
const VAL_0168: ValueAtom<'static> = ValueAtom::Float(0.422551);
const VAL_0169: ValueAtom<'static> = ValueAtom::Float(0.145576);
const VAL_0170: ValueAtom<'static> = ValueAtom::Float(-0.623190);
const VAL_0171: ValueAtom<'static> = ValueAtom::Float(-0.317324);
const VAL_0172: ValueAtom<'static> = ValueAtom::Float(-0.591051);
const VAL_0173: ValueAtom<'static> = ValueAtom::Float(-0.405607);
const VAL_0174: ValueAtom<'static> = ValueAtom::Float(-0.313148);
const VAL_0175: ValueAtom<'static> = ValueAtom::Float(0.159416);
const VAL_0176: ValueAtom<'static> = ValueAtom::Float(-0.254651);
const VAL_0177: ValueAtom<'static> = ValueAtom::Float(-0.799896);
const VAL_0178: ValueAtom<'static> = ValueAtom::Float(-0.551309);
const VAL_0179: ValueAtom<'static> = ValueAtom::Str("final");
const VAL_0180: ValueAtom<'static> = ValueAtom::Float(-0.707084);
const VAL_0181: ValueAtom<'static> = ValueAtom::Float(-0.901874);
const VAL_0182: ValueAtom<'static> = ValueAtom::Float(0.196466);
const VAL_0183: ValueAtom<'static> = ValueAtom::Float(0.003824);
const VAL_0184: ValueAtom<'static> = ValueAtom::Float(-0.128590);
const VAL_0185: ValueAtom<'static> = ValueAtom::Float(-0.219339);
const VAL_0186: ValueAtom<'static> = ValueAtom::Float(-0.516734);
const VAL_0187: ValueAtom<'static> = ValueAtom::Str("single");
const VAL_0188: ValueAtom<'static> = ValueAtom::Float(0.159445);
const VAL_0189: ValueAtom<'static> = ValueAtom::Float(3.5);
const VAL_0190: ValueAtom<'static> = ValueAtom::Float(-0.419103);
const VAL_0191: ValueAtom<'static> = ValueAtom::Float(-0.092856);
const VAL_0192: ValueAtom<'static> = ValueAtom::Float(-0.576116);
const VAL_0193: ValueAtom<'static> = ValueAtom::Str("3");
const VAL_0194: ValueAtom<'static> = ValueAtom::Float(-0.645830);
const VAL_0195: ValueAtom<'static> = ValueAtom::Float(-0.466500);
const VAL_0196: ValueAtom<'static> = ValueAtom::Float(-0.217292);
const VAL_0197: ValueAtom<'static> = ValueAtom::Float(-0.304382);
const VAL_0198: ValueAtom<'static> = ValueAtom::Float(-0.572203);
const VAL_0199: ValueAtom<'static> = ValueAtom::Float(-0.240338);
const VAL_0200: ValueAtom<'static> = ValueAtom::Float(-0.588171);
const VAL_0201: ValueAtom<'static> = ValueAtom::Float(-0.957970);
const VAL_0202: ValueAtom<'static> = ValueAtom::Float(3.9);
const VAL_0203: ValueAtom<'static> = ValueAtom::Float(-0.959427);
const VAL_0204: ValueAtom<'static> = ValueAtom::Float(-0.845747);
const VAL_0205: ValueAtom<'static> = ValueAtom::Float(-0.482247);
const VAL_0206: ValueAtom<'static> = ValueAtom::Float(-0.632362);
const VAL_0207: ValueAtom<'static> = ValueAtom::Float(-0.713117);
const VAL_0208: ValueAtom<'static> = ValueAtom::Float(-0.924308);
const VAL_0209: ValueAtom<'static> = ValueAtom::Float(-0.891342);
const VAL_0210: ValueAtom<'static> = ValueAtom::Float(-1.152_52);
const VAL_0211: ValueAtom<'static> = ValueAtom::Float(-0.599624);
const VAL_0212: ValueAtom<'static> = ValueAtom::Float(-0.077191);
const VAL_0213: ValueAtom<'static> = ValueAtom::Float(-1.032_42);
const VAL_0214: ValueAtom<'static> = ValueAtom::Float(-0.542799);
const VAL_0215: ValueAtom<'static> = ValueAtom::Float(2.8);
const VAL_0216: ValueAtom<'static> = ValueAtom::Float(-0.423979);
const VAL_0217: ValueAtom<'static> = ValueAtom::Float(-0.766379);
const VAL_0218: ValueAtom<'static> = ValueAtom::Str("to");
const VAL_0219: ValueAtom<'static> = ValueAtom::Float(-0.792895);
const VAL_0220: ValueAtom<'static> = ValueAtom::Float(-0.276816);
const VAL_0221: ValueAtom<'static> = ValueAtom::Float(-0.523721);
const VAL_0222: ValueAtom<'static> = ValueAtom::Float(-0.488102);
const VAL_0223: ValueAtom<'static> = ValueAtom::Float(-0.731758);
const VAL_0224: ValueAtom<'static> = ValueAtom::Float(-0.822229);
const VAL_0225: ValueAtom<'static> = ValueAtom::Float(1.023_34);
const VAL_0226: ValueAtom<'static> = ValueAtom::Float(0.536277);
const VAL_0227: ValueAtom<'static> = ValueAtom::Float(0.138201);
const VAL_0228: ValueAtom<'static> = ValueAtom::Float(-0.234710);
const VAL_0229: ValueAtom<'static> = ValueAtom::Float(-0.525292);
const VAL_0230: ValueAtom<'static> = ValueAtom::Float(0.417485);
const VAL_0231: ValueAtom<'static> = ValueAtom::Float(-0.078200);
const VAL_0232: ValueAtom<'static> = ValueAtom::Float(-0.569410);
const VAL_0233: ValueAtom<'static> = ValueAtom::Float(-0.289362);
const VAL_0234: ValueAtom<'static> = ValueAtom::Float(-0.092104);
const VAL_0235: ValueAtom<'static> = ValueAtom::Float(0.139463);
const VAL_0236: ValueAtom<'static> = ValueAtom::Float(-0.070872);
const VAL_0237: ValueAtom<'static> = ValueAtom::Float(-0.618971);
const VAL_0238: ValueAtom<'static> = ValueAtom::Float(-0.840495);
const VAL_0239: ValueAtom<'static> = ValueAtom::Float(0.009134);
const VAL_0240: ValueAtom<'static> = ValueAtom::Float(-0.512523);
const VAL_0241: ValueAtom<'static> = ValueAtom::Float(0.121704);
const VAL_0242: ValueAtom<'static> = ValueAtom::Float(-0.256370);
const VAL_0243: ValueAtom<'static> = ValueAtom::Float(3.1);
const VAL_0244: ValueAtom<'static> = ValueAtom::Float(-0.474522);
const VAL_0245: ValueAtom<'static> = ValueAtom::Float(-0.247206);
const VAL_0246: ValueAtom<'static> = ValueAtom::Float(-0.597866);
const VAL_0247: ValueAtom<'static> = ValueAtom::Float(-0.407765);
const VAL_0248: ValueAtom<'static> = ValueAtom::Float(-0.741256);
const VAL_0249: ValueAtom<'static> = ValueAtom::Float(-1.084_26);
const VAL_0250: ValueAtom<'static> = ValueAtom::Float(-0.397890);
const VAL_0251: ValueAtom<'static> = ValueAtom::Float(2.6);
const VAL_0252: ValueAtom<'static> = ValueAtom::Float(-0.666011);
const VAL_0253: ValueAtom<'static> = ValueAtom::Float(-0.499492);
const VAL_0254: ValueAtom<'static> = ValueAtom::Float(-0.253186);
const VAL_0255: ValueAtom<'static> = ValueAtom::Float(-0.372832);
const VAL_0256: ValueAtom<'static> = ValueAtom::Float(-0.093649);
const VAL_0257: ValueAtom<'static> = ValueAtom::Float(-0.249982);
const VAL_0258: ValueAtom<'static> = ValueAtom::Float(3.2);
const VAL_0259: ValueAtom<'static> = ValueAtom::Float(0.180860);
const VAL_0260: ValueAtom<'static> = ValueAtom::Float(-0.040291);
const VAL_0261: ValueAtom<'static> = ValueAtom::Str("4");
const VAL_0262: ValueAtom<'static> = ValueAtom::Float(1.632_03);
const VAL_0263: ValueAtom<'static> = ValueAtom::Float(0.994933);
const VAL_0264: ValueAtom<'static> = ValueAtom::Float(0.214457);
const VAL_0265: ValueAtom<'static> = ValueAtom::Float(0.730381);
const VAL_0266: ValueAtom<'static> = ValueAtom::Float(-0.336221);
const VAL_0267: ValueAtom<'static> = ValueAtom::Float(0.468302);
const VAL_0268: ValueAtom<'static> = ValueAtom::Float(-0.799121);
const VAL_0269: ValueAtom<'static> = ValueAtom::Float(0.030061);
const VAL_0270: ValueAtom<'static> = ValueAtom::Str("d");
const VAL_0271: ValueAtom<'static> = ValueAtom::Float(1.164_9);
const VAL_0272: ValueAtom<'static> = ValueAtom::Float(2.266_8);
const VAL_0273: ValueAtom<'static> = ValueAtom::Float(1.503_75);
const VAL_0274: ValueAtom<'static> = ValueAtom::Float(2.079_27);
const VAL_0275: ValueAtom<'static> = ValueAtom::Float(1.102_43);
const VAL_0276: ValueAtom<'static> = ValueAtom::Float(1.843_2);
const VAL_0277: ValueAtom<'static> = ValueAtom::Float(1.598_53);
const VAL_0278: ValueAtom<'static> = ValueAtom::Float(1.129_27);
const VAL_0279: ValueAtom<'static> = ValueAtom::Float(0.442376);
const VAL_0280: ValueAtom<'static> = ValueAtom::Float(1.765_08);
const VAL_0281: ValueAtom<'static> = ValueAtom::Float(0.748600);
const VAL_0282: ValueAtom<'static> = ValueAtom::Float(2.308_26);
const VAL_0283: ValueAtom<'static> = ValueAtom::Float(1.699_17);
const VAL_0284: ValueAtom<'static> = ValueAtom::Float(1.311_28);
const VAL_0285: ValueAtom<'static> = ValueAtom::Float(0.212421);
const VAL_0286: ValueAtom<'static> = ValueAtom::Float(0.653094);
const VAL_0287: ValueAtom<'static> = ValueAtom::Float(1.258_02);
const VAL_0288: ValueAtom<'static> = ValueAtom::Float(0.777568);
const VAL_0289: ValueAtom<'static> = ValueAtom::Float(0.163941);
const VAL_0290: ValueAtom<'static> = ValueAtom::Float(-0.167063);
const VAL_0291: ValueAtom<'static> = ValueAtom::Float(-0.000859);
const VAL_0292: ValueAtom<'static> = ValueAtom::Float(0.273433);
const VAL_0293: ValueAtom<'static> = ValueAtom::Float(1.056_94);
const VAL_0294: ValueAtom<'static> = ValueAtom::Float(0.244916);
const VAL_0295: ValueAtom<'static> = ValueAtom::Float(1.211_87);
const VAL_0296: ValueAtom<'static> = ValueAtom::Float(0.598650);
const VAL_0297: ValueAtom<'static> = ValueAtom::Float(1.163_4);
const VAL_0298: ValueAtom<'static> = ValueAtom::Float(0.292935);
const VAL_0299: ValueAtom<'static> = ValueAtom::Float(0.925740);
const VAL_0300: ValueAtom<'static> = ValueAtom::Float(1.234_84);
const VAL_0301: ValueAtom<'static> = ValueAtom::Float(2.020_08);
const VAL_0302: ValueAtom<'static> = ValueAtom::Float(0.697089);
const VAL_0303: ValueAtom<'static> = ValueAtom::Float(0.992197);
const VAL_0304: ValueAtom<'static> = ValueAtom::Float(1.510_93);
const VAL_0305: ValueAtom<'static> = ValueAtom::Float(0.520952);
const VAL_0306: ValueAtom<'static> = ValueAtom::Float(0.185827);
const VAL_0307: ValueAtom<'static> = ValueAtom::Float(0.033230);
const VAL_0308: ValueAtom<'static> = ValueAtom::Float(-0.534917);
const VAL_0309: ValueAtom<'static> = ValueAtom::Float(0.575107);
const VAL_0310: ValueAtom<'static> = ValueAtom::Float(-0.111275);
const VAL_0311: ValueAtom<'static> = ValueAtom::Float(0.094470);
const VAL_0312: ValueAtom<'static> = ValueAtom::Float(0.381947);
const VAL_0313: ValueAtom<'static> = ValueAtom::Float(-0.490108);
const VAL_0314: ValueAtom<'static> = ValueAtom::Float(-0.201268);
const VAL_0315: ValueAtom<'static> = ValueAtom::Float(1.203_97);
const VAL_0316: ValueAtom<'static> = ValueAtom::Float(0.636568);
const VAL_0317: ValueAtom<'static> = ValueAtom::Float(1.077_63);
const VAL_0318: ValueAtom<'static> = ValueAtom::Float(-0.016336);
const VAL_0319: ValueAtom<'static> = ValueAtom::Float(1.072_53);
const VAL_0320: ValueAtom<'static> = ValueAtom::Float(0.525806);
const VAL_0321: ValueAtom<'static> = ValueAtom::Float(0.952792);
const VAL_0322: ValueAtom<'static> = ValueAtom::Float(0.469117);
const VAL_0323: ValueAtom<'static> = ValueAtom::Float(-0.071645);
const VAL_0324: ValueAtom<'static> = ValueAtom::Float(0.457137);
const VAL_0325: ValueAtom<'static> = ValueAtom::Float(0.102492);
const VAL_0326: ValueAtom<'static> = ValueAtom::Float(0.697337);
const VAL_0327: ValueAtom<'static> = ValueAtom::Float(0.375114);
const VAL_0328: ValueAtom<'static> = ValueAtom::Float(0.410671);
const VAL_0329: ValueAtom<'static> = ValueAtom::Float(0.800000);
const VAL_0330: ValueAtom<'static> = ValueAtom::Float(-0.331055);
const VAL_0331: ValueAtom<'static> = ValueAtom::Float(-0.240616);
const VAL_0332: ValueAtom<'static> = ValueAtom::Float(-0.019127);
const VAL_0333: ValueAtom<'static> = ValueAtom::Float(0.556537);
const VAL_0334: ValueAtom<'static> = ValueAtom::Float(0.153892);
const VAL_0335: ValueAtom<'static> = ValueAtom::Float(0.123242);
const VAL_0336: ValueAtom<'static> = ValueAtom::Float(0.295753);
const VAL_0337: ValueAtom<'static> = ValueAtom::Float(-0.341018);
const VAL_0338: ValueAtom<'static> = ValueAtom::Float(-0.008931);
const VAL_0339: ValueAtom<'static> = ValueAtom::Float(-0.744625);
const VAL_0340: ValueAtom<'static> = ValueAtom::Float(-0.302803);
const VAL_0341: ValueAtom<'static> = ValueAtom::Float(0.113815);
const VAL_0342: ValueAtom<'static> = ValueAtom::Float(-0.128733);
const VAL_0343: ValueAtom<'static> = ValueAtom::Float(-0.854509);
const VAL_0344: ValueAtom<'static> = ValueAtom::Float(-0.216179);
const VAL_0345: ValueAtom<'static> = ValueAtom::Float(0.461950);
const VAL_0346: ValueAtom<'static> = ValueAtom::Float(0.657169);
const VAL_0347: ValueAtom<'static> = ValueAtom::Float(1.082_22);
const VAL_0348: ValueAtom<'static> = ValueAtom::Float(1.462_57);
const VAL_0349: ValueAtom<'static> = ValueAtom::Float(0.785204);
const VAL_0350: ValueAtom<'static> = ValueAtom::Float(0.321168);
const VAL_0351: ValueAtom<'static> = ValueAtom::Float(0.950834);
const VAL_0352: ValueAtom<'static> = ValueAtom::Float(-0.167374);
const VAL_0353: ValueAtom<'static> = ValueAtom::Float(-0.003744);
const VAL_0354: ValueAtom<'static> = ValueAtom::Float(0.228448);
const VAL_0355: ValueAtom<'static> = ValueAtom::Float(0.504252);
const VAL_0356: ValueAtom<'static> = ValueAtom::Float(0.736476);
const VAL_0357: ValueAtom<'static> = ValueAtom::Float(0.059097);
const VAL_0358: ValueAtom<'static> = ValueAtom::Float(-0.431535);
const VAL_0359: ValueAtom<'static> = ValueAtom::Float(1.006_42);
const VAL_0360: ValueAtom<'static> = ValueAtom::Float(0.481652);
const VAL_0361: ValueAtom<'static> = ValueAtom::Float(0.749861);
const VAL_0362: ValueAtom<'static> = ValueAtom::Float(0.069631);
const VAL_0363: ValueAtom<'static> = ValueAtom::Float(0.552212);
const VAL_0364: ValueAtom<'static> = ValueAtom::Float(-0.047922);
const VAL_0365: ValueAtom<'static> = ValueAtom::Float(-1.060_9);
const VAL_0366: ValueAtom<'static> = ValueAtom::Float(-0.599330);
const VAL_0367: ValueAtom<'static> = ValueAtom::Float(0.006987);
const VAL_0368: ValueAtom<'static> = ValueAtom::Float(-0.064904);
const VAL_0369: ValueAtom<'static> = ValueAtom::Float(-0.248899);
const VAL_0370: ValueAtom<'static> = ValueAtom::Float(-0.601987);
const VAL_0371: ValueAtom<'static> = ValueAtom::Float(-0.302401);
const VAL_0372: ValueAtom<'static> = ValueAtom::Float(0.164636);
const VAL_0373: ValueAtom<'static> = ValueAtom::Float(-0.098905);
const VAL_0374: ValueAtom<'static> = ValueAtom::Float(-0.316836);
const VAL_0375: ValueAtom<'static> = ValueAtom::Float(-0.096119);
const VAL_0376: ValueAtom<'static> = ValueAtom::Float(-0.429437);
const VAL_0377: ValueAtom<'static> = ValueAtom::Float(-0.065274);
const VAL_0378: ValueAtom<'static> = ValueAtom::Float(-0.635089);
const VAL_0379: ValueAtom<'static> = ValueAtom::Float(0.013936);
const VAL_0380: ValueAtom<'static> = ValueAtom::Float(-0.454845);
const VAL_0381: ValueAtom<'static> = ValueAtom::Float(0.809091);
const VAL_0382: ValueAtom<'static> = ValueAtom::Float(-0.277092);
const VAL_0383: ValueAtom<'static> = ValueAtom::Float(0.281001);
const VAL_0384: ValueAtom<'static> = ValueAtom::Float(0.699145);
const VAL_0385: ValueAtom<'static> = ValueAtom::Float(0.241873);
const VAL_0386: ValueAtom<'static> = ValueAtom::Float(-0.470784);
const VAL_0387: ValueAtom<'static> = ValueAtom::Float(-0.072112);
const VAL_0388: ValueAtom<'static> = ValueAtom::Float(0.073349);
const VAL_0389: ValueAtom<'static> = ValueAtom::Float(0.608371);
const VAL_0390: ValueAtom<'static> = ValueAtom::Float(-0.293282);
const VAL_0391: ValueAtom<'static> = ValueAtom::Float(-0.081611);
const VAL_0392: ValueAtom<'static> = ValueAtom::Float(-0.504024);
const VAL_0393: ValueAtom<'static> = ValueAtom::Float(0.983950);
const VAL_0394: ValueAtom<'static> = ValueAtom::Float(0.634789);
const VAL_0395: ValueAtom<'static> = ValueAtom::Float(4.4);
const VAL_0396: ValueAtom<'static> = ValueAtom::Float(0.479029);
const VAL_0397: ValueAtom<'static> = ValueAtom::Float(0.143214);
const VAL_0398: ValueAtom<'static> = ValueAtom::Float(0.406834);
const VAL_0399: ValueAtom<'static> = ValueAtom::Float(0.600000);
const VAL_0400: ValueAtom<'static> = ValueAtom::Float(-0.415599);
const VAL_0401: ValueAtom<'static> = ValueAtom::Float(0.110288);
const VAL_0402: ValueAtom<'static> = ValueAtom::Float(0.031419);
const VAL_0403: ValueAtom<'static> = ValueAtom::Float(0.693893);
const VAL_0404: ValueAtom<'static> = ValueAtom::Float(6.000000);
const VAL_0405: ValueAtom<'static> = ValueAtom::Float(0.215675);
const VAL_0406: ValueAtom<'static> = ValueAtom::Float(0.574068);
const VAL_0407: ValueAtom<'static> = ValueAtom::Float(-0.458142);
const VAL_0408: ValueAtom<'static> = ValueAtom::Float(0.304628);
const VAL_0409: ValueAtom<'static> = ValueAtom::Float(-0.230940);
const VAL_0410: ValueAtom<'static> = ValueAtom::Float(0.326954);
const VAL_0411: ValueAtom<'static> = ValueAtom::Float(-0.100616);
const VAL_0412: ValueAtom<'static> = ValueAtom::Float(-0.091913);
const VAL_0413: ValueAtom<'static> = ValueAtom::Float(0.219053);
const VAL_0414: ValueAtom<'static> = ValueAtom::Float(0.216118);
const VAL_0415: ValueAtom<'static> = ValueAtom::Float(-0.008341);
const VAL_0416: ValueAtom<'static> = ValueAtom::Float(0.761763);
const VAL_0417: ValueAtom<'static> = ValueAtom::Float(0.332721);
const VAL_0418: ValueAtom<'static> = ValueAtom::Float(0.217178);
const VAL_0419: ValueAtom<'static> = ValueAtom::Float(1.294_51);
const VAL_0420: ValueAtom<'static> = ValueAtom::Float(4.000000);
const VAL_0421: ValueAtom<'static> = ValueAtom::Float(0.945261);
const VAL_0422: ValueAtom<'static> = ValueAtom::Float(0.687498);
const VAL_0423: ValueAtom<'static> = ValueAtom::Float(0.403076);
const VAL_0424: ValueAtom<'static> = ValueAtom::Float(1.002_55);
const VAL_0425: ValueAtom<'static> = ValueAtom::Float(1.091_13);
const VAL_0426: ValueAtom<'static> = ValueAtom::Float(0.209045);
const VAL_0427: ValueAtom<'static> = ValueAtom::Float(-0.054407);
const VAL_0428: ValueAtom<'static> = ValueAtom::Float(0.256045);
const VAL_0429: ValueAtom<'static> = ValueAtom::Float(-0.967300);
const VAL_0430: ValueAtom<'static> = ValueAtom::Float(-0.351397);
const VAL_0431: ValueAtom<'static> = ValueAtom::Float(-0.623300);
const VAL_0432: ValueAtom<'static> = ValueAtom::Float(0.266234);
const VAL_0433: ValueAtom<'static> = ValueAtom::Float(-0.302281);
const VAL_0434: ValueAtom<'static> = ValueAtom::Float(-0.010244);
const VAL_0435: ValueAtom<'static> = ValueAtom::Float(-0.274514);
const VAL_0436: ValueAtom<'static> = ValueAtom::Float(0.048218);
const VAL_0437: ValueAtom<'static> = ValueAtom::Float(0.888495);
const VAL_0438: ValueAtom<'static> = ValueAtom::Float(0.653018);
const VAL_0439: ValueAtom<'static> = ValueAtom::Float(0.061289);
const VAL_0440: ValueAtom<'static> = ValueAtom::Float(0.346637);
const VAL_0441: ValueAtom<'static> = ValueAtom::Float(0.041181);
const VAL_0442: ValueAtom<'static> = ValueAtom::Float(0.613305);
const VAL_0443: ValueAtom<'static> = ValueAtom::Float(0.175467);
const VAL_0444: ValueAtom<'static> = ValueAtom::Float(-0.276407);
const VAL_0445: ValueAtom<'static> = ValueAtom::Float(-0.550878);
const VAL_0446: ValueAtom<'static> = ValueAtom::Float(-0.240328);
const VAL_0447: ValueAtom<'static> = ValueAtom::Float(0.330352);
const VAL_0448: ValueAtom<'static> = ValueAtom::Float(-0.081668);
const VAL_0449: ValueAtom<'static> = ValueAtom::Float(0.383533);
const VAL_0450: ValueAtom<'static> = ValueAtom::Float(-0.324515);
const VAL_0451: ValueAtom<'static> = ValueAtom::Float(-0.624870);
const VAL_0452: ValueAtom<'static> = ValueAtom::Float(-0.513869);
const VAL_0453: ValueAtom<'static> = ValueAtom::Float(0.207874);
const VAL_0454: ValueAtom<'static> = ValueAtom::Float(-0.020471);
const VAL_0455: ValueAtom<'static> = ValueAtom::Float(0.397372);
const VAL_0456: ValueAtom<'static> = ValueAtom::Float(0.271734);
const VAL_0457: ValueAtom<'static> = ValueAtom::Float(-0.261466);
const VAL_0458: ValueAtom<'static> = ValueAtom::Float(-0.009566);
const VAL_0459: ValueAtom<'static> = ValueAtom::Float(-0.381895);
const VAL_0460: ValueAtom<'static> = ValueAtom::Float(-0.089877);
const VAL_0461: ValueAtom<'static> = ValueAtom::Float(-1.126_26);
const VAL_0462: ValueAtom<'static> = ValueAtom::Float(-0.906926);
const VAL_0463: ValueAtom<'static> = ValueAtom::Float(-0.625651);
const VAL_0464: ValueAtom<'static> = ValueAtom::Float(-0.385089);
const VAL_0465: ValueAtom<'static> = ValueAtom::Float(-0.359702);
const VAL_0466: ValueAtom<'static> = ValueAtom::Float(0.216904);
const VAL_0467: ValueAtom<'static> = ValueAtom::Float(-0.394349);
const VAL_0468: ValueAtom<'static> = ValueAtom::Float(-0.860573);
const VAL_0469: ValueAtom<'static> = ValueAtom::Float(-0.510488);
const VAL_0470: ValueAtom<'static> = ValueAtom::Float(0.010843);
const VAL_0471: ValueAtom<'static> = ValueAtom::Float(-0.035054);
const VAL_0472: ValueAtom<'static> = ValueAtom::Float(-0.179727);
const VAL_0473: ValueAtom<'static> = ValueAtom::Float(-0.297341);
const VAL_0474: ValueAtom<'static> = ValueAtom::Float(-0.542602);
const VAL_0475: ValueAtom<'static> = ValueAtom::Float(-0.604960);
const VAL_0476: ValueAtom<'static> = ValueAtom::Float(-0.432058);
const VAL_0477: ValueAtom<'static> = ValueAtom::Float(-0.389079);
const VAL_0478: ValueAtom<'static> = ValueAtom::Float(-0.735640);
const VAL_0479: ValueAtom<'static> = ValueAtom::Float(-0.605444);
const VAL_0480: ValueAtom<'static> = ValueAtom::Float(-0.827377);
const VAL_0481: ValueAtom<'static> = ValueAtom::Float(-0.275338);
const VAL_0482: ValueAtom<'static> = ValueAtom::Float(-0.802801);
const VAL_0483: ValueAtom<'static> = ValueAtom::Float(-0.371234);
const VAL_0484: ValueAtom<'static> = ValueAtom::Float(-0.772883);
const VAL_0485: ValueAtom<'static> = ValueAtom::Float(-0.655006);
const VAL_0486: ValueAtom<'static> = ValueAtom::Float(-0.303751);
const VAL_0487: ValueAtom<'static> = ValueAtom::Float(-0.456882);
const VAL_0488: ValueAtom<'static> = ValueAtom::Float(-0.133182);
const VAL_0489: ValueAtom<'static> = ValueAtom::Float(0.114442);
const VAL_0490: ValueAtom<'static> = ValueAtom::Float(-0.167545);
const VAL_0491: ValueAtom<'static> = ValueAtom::Float(-0.876950);
const VAL_0492: ValueAtom<'static> = ValueAtom::Float(-0.640572);
const VAL_0493: ValueAtom<'static> = ValueAtom::Float(-0.321322);
const VAL_0494: ValueAtom<'static> = ValueAtom::Float(-0.925472);
